...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../core */ "./src/js/lib/core.js");
 // вставляет текст или же возвращает текст элемента
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.eq = function (i) {
  ...
  this.length = 1;
  return this;
}; // возвращает индекс элемента относительно его родителя
...
}; // находит элементы по селектору в элементе
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.find = function (selector) {
  ...
  return this;
}; // возвращает ближайший элемент с указаным селектором
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.closest = function (selector) {
  ...
  return this;
}; // получаем соседние элементы кроме самого элемента
...
console.log(Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.more'));
console.log(Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.more').sibling()); // console.log($('div').eq(2).find('.some'));
